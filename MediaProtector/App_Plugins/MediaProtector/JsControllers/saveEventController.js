angular.module("umbraco").controller("saveEventController", function ($http, mediaResource, editorService, $route, mpResource, usersResource, userService, mpPropertyEditor, notificationsService) {
    var vm = this;
    vm.Name = "Save Controller";
    ...
    mpResource.getSaveEventModel().then(function (response) {
    ...
    vm.saveSettings = function () {
        ...
        mpResource.updateSaveEventModel(eventModel).then(function (response) {
            notificationsService.success('Saved ', " settings for save event");
