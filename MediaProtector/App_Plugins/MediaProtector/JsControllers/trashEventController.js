angular.module("umbraco").controller("trashEventController", function ($http, mediaResource, editorService, $route, mpResource, usersResource, userService, mpPropertyEditor, notificationsService) {
    var vm = this;
    vm.Name = "Trash Controller";
    ...
    mpResource.getTrashEventModel().then(function (response) {
    ...
    vm.saveSettings = function () {
        ...
        mpResource.updateTrashEventModel(eventModel).then(function (response) {
            notificationsService.success('Saved ', " settings for trash event");
